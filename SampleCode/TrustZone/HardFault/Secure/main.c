    ...
    */
    ...
    do
    {
        ...
        switch (ch)
        {
            ...
            case '1':
                M32(FMC_APROM_BASE) = 0;        /* Write to APROM to generate Hard Fault */
                break;

            case '2':
                M32(FMC_NON_SECURE_BASE) = 0;   /* Write to Non-secure to generate Hard Fault */
                break;
