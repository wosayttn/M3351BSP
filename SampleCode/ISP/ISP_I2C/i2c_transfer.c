 ...
 * @file     i2c_transfer.c
 * @version  V1.00
 * @brief    I2C ISP support function source file
 *
...
#define I2C_CLK    (100000)     /* I2C clock speed 100K */
...
void I2C_Init(void)
{
    ...
    I2C1->CLKDIV = (uint32_t)(((CLK_GetPCLK1Freq() * 10U) / (I2C_CLK * 4U) + 5U) / 10U - 1U); /* Compute proper divider for I2C clock */
