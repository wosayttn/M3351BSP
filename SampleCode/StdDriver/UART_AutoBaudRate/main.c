...
uint32_t GetUartBaudrate(UART_T *psUART)
{
    ...
    else if (psUART == UART2)
    {
        ...
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV1 & CLK_CLKDIV1_UART2DIV_Msk) >> CLK_CLKDIV1_UART2DIV_Pos;
    }
    else if (psUART == (UART_T *)UART3)
    {
        ...
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV1 & CLK_CLKDIV1_UART3DIV_Msk) >> CLK_CLKDIV1_UART3DIV_Pos;
    }
    else if (psUART == (UART_T *)UART4)
    {
        ...
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV1 & CLK_CLKDIV1_UART4DIV_Msk) >> CLK_CLKDIV1_UART4DIV_Pos;
    }
    else if (psUART == (UART_T *)UART5)
    {
        ...
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV2 & CLK_CLKDIV2_UART5DIV_Msk) >> CLK_CLKDIV2_UART5DIV_Pos;
    }
    else if (psUART == (UART_T *)UART6)
    {
        ...
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV2 & CLK_CLKDIV2_UART6DIV_Msk) >> CLK_CLKDIV2_UART6DIV_Pos;
    }
    else if (psUART == (UART_T *)UART7)
    {
        ...
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV2 & CLK_CLKDIV2_UART7DIV_Msk) >> CLK_CLKDIV2_UART7DIV_Pos;
    }
    else if (psUART == (UART_T *)UART8)
    {
        /* Get UART clock source selection */
        u32UartClkSrcSel = (CLK->CLKSEL3 & CLK_CLKSEL3_UART8SEL_Msk) >> CLK_CLKSEL3_UART8SEL_Pos;
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV2 & CLK_CLKDIV2_UART8DIV_Msk) >> CLK_CLKDIV2_UART8DIV_Pos;
    }
    else if (psUART == (UART_T *)UART9)
    {
        /* Get UART clock source selection */
        u32UartClkSrcSel = (CLK->CLKSEL3 & CLK_CLKSEL3_UART9SEL_Msk) >> CLK_CLKSEL3_UART9SEL_Pos;
        /* Get UART clock divider number */
        u32UartClkDivNum = (CLK->CLKDIV2 & CLK_CLKDIV2_UART9DIV_Msk) >> CLK_CLKDIV2_UART9DIV_Pos;
    }

    /* Get PLL clock frequency if UART clock source selection is PLL/2 */
    if (u32UartClkSrcSel == 1ul)
    {
        u32ClkTbl[u32UartClkSrcSel] = CLK_GetPLLClockFreq() >> 1;
    }
