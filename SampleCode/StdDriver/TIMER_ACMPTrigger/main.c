...
int main(void)
{
    ...
    TIMER_CaptureSelect(TIMER0, TIMER_INTERCAPSEL_ACMP1);
    ...
    ACMP_Open(ACMP01, ACMP_CH, ACMP_CTL_NEGSEL_VBG, ACMP_CTL_HYSTERESIS_DISABLE);
    /* Select P1 as ACMP1 positive input channel */
    ACMP_SELECT_P(ACMP01, ACMP_CH, ACMP_CTL_POSSEL_P1);
