...
void BPWM0_IRQHandler(void)
{
    ...
    {
        BPWM_SET_CNR(BPWM0, BPWM_OUT_CH, 599);
        BPWM_SET_CMR(BPWM0, BPWM_OUT_CH, 100);
    }

    u32Toggle ^= 1;

    while (BPWM_GetPeriodIntFlag(BPWM0, BPWM_OUT_CH))
    {
        if (--u32TimeOutCnt == 0)
        {
...
int main(void)
{
    ...
    /*
      ...
      Period = 72 MHz / (1 * 1 * (449 + 1)) =  160000 Hz
    ...
    */
    ...
    BPWM_EnablePeriodInt(BPWM0, BPWM_OUT_CH, 0);
