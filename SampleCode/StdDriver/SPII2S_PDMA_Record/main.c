 ...
 * @file    main.c
 * @version V1.00
 * @brief   An I2S demo for recording data and demonstrating how I2S works with PDMA.
 *
...
int32_t main(void)
{
    ...
    PDMA_SetTransferMode(PDMA0, I2S_TX_DMA_CH, PDMA_SPI0_TX, 1, (uint32_t)&g_asDescTable_DataTX[0]);
