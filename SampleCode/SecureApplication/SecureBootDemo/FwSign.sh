...
# To sign image
"${script_path}/../../../Tool/imgtool" sign -k "${key_file}" --public-key-format hash --align 4 -v 1.2.3+10 -H 0x400 --pad-header -S 0x40000 -s ${fw_ver} "${bin_file}" "${script_path}/${bin_basename}_sc${fw_ver}_signed.bin"
