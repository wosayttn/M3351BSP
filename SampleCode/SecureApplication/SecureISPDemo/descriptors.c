...
static uint8_t HID_DeviceReportDescriptor[] =
{
...
static uint8_t gu8StringLang[4] =
{
    4,              /* bLength */
...
static uint8_t gu8VendorStringDesc[] =
{
    16,
    DESC_STRING,
...
static uint8_t gu8ProductStringDesc[] =
{
    32,             /* bLength          */
    DESC_STRING,    /* bDescriptorType  */
...
static uint8_t gu8StringSerial[26] =
{
    26,             // bLength
    DESC_STRING,    // bDescriptorType
...
static uint8_t *gu8UsbHidReport[2] =
{
    HID_DeviceReportDescriptor,
    NULL,
};

static uint32_t gu32UsbHidReportLen[2] =
{
    sizeof(HID_DeviceReportDescriptor),
    0,
};

static uint32_t gu32ConfigHidDescIdx[2] =
{
