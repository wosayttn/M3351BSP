...
/*------------------------------*/
#define XOM_ADD_ADDR    0x00004001
#define XOM_SUB_ADDR    0x00004005
#define XOM_MUL_ADDR    0x00004009
#define XOM_DIV_ADDR    0x0000400D
#define XOM_SUM_ADDR    0x00004013
