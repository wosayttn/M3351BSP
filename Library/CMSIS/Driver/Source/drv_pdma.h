/**************************************************************************//**
 * @file     drv_pdma.h
 * @brief    PDMA high level driver for M3351 series
 *
...
#include "NuMicro.h"
    ...
    #define NU_PDMA_SGTBL_POOL_SIZE     (12)
#endif
...
#define NU_PDMA_EVENT_ALL               (NU_PDMA_EVENT_ABORT | NU_PDMA_EVENT_TRANSFER_DONE)
