...
typedef struct
{
     ...
     * |        |          |Check EPSTS0~22 in USBD_EPSTS0~2 to know which kind of USB event was occurred, cleared by writing 1 to USBD_INTSTS[1] or USBD_INTSTS[27:16] or USBD_EPINTSTS[24:0] and SETUP (USBD_INTSTS[31]).
    ...
    USBD_EP_T     EP[23];                /*!< [0x500-0x66c] USB End Point 0 ~ 22 Configuration Register                 */
...
#define USBD_CFG_DBTGACTIVE_Pos          (10)                                              /*!< USBD_T::CFG: DBTGACTIVE Position       */
#define USBD_CFG_DBTGACTIVE_Msk          (0x1ul << USBD_CFG_DBTGACTIVE_Pos)                /*!< USBD_T::CFG: DBTGACTIVE Mask           */

#define USBD_CFG_DBEN_Pos                (11)                                              /*!< USBD_T::CFG: DBEN Position             */
#define USBD_CFG_DBEN_Msk                (0x1ul << USBD_CFG_DBEN_Pos)                      /*!< USBD_T::CFG: DBEN Mask                 */
