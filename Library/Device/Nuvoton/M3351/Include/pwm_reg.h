...
typedef struct
{
     ...
     * Offset: 0x20C  PWM Rising Capture Data Register 0~5
     * ---------------------------------------------------------------------------------------------------
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |FCAPDAT   |PWM Falling Capture Data (Read Only)
...
typedef struct
{
     ...
     * |        |          |Others = Reserved.
     * @var PWM_T::CLKPSC[3]
     * Offset: 0x14, 0x18, 0x1C PWM Clock Prescale Register 0/1, 2/3, 4/5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |1 = Clear 16-bit PWM counter to 0000H.
     * @var PWM_T::PERIOD[6]
     * Offset: 0x30,0x38,0x40  PWM Period Register 0/2/4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * @var PWM_T::CNT[6]
     * Offset: 0x90,0x98,0xA0  PWM Counter Register 0/2/4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |1 = brake pin event will be detected if PWMx_BRAKE0 pin status transfer from high to low in edge-detect, or pin status is low in level-detect.Brake 0 Pin Inverse
     ...
     * |        |          |0 = bBrake pin event will be detected if PWMx_BRAKE1 pin status transfer from low to high in edge-detect, or pin status is high in level-detect.
     * |        |          |1 = bBrake pin event will be detected if PWMx_BRAKE1 pin status transfer from high to low in edge-detect, or pin status is low in level-detect.Brake 1 Pin Inverse
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |ZTE0      |PWM Zero Point Trigger DAC Enable Bit 0
     * |        |          |PWM can trigger EADC/DAC/DMA to start action when PWM counter down count to zero if this bit is set to1.
     * |        |          |0 = PWM period point trigger DAC function Disabled.
     * |        |          |1 = PWM period point trigger DAC function Enabled.
     * |[2]     |ZTE2      |PWM Zero Point Trigger DAC Enable Bit 2
     * |        |          |PWM can trigger EADC/DAC/DMA to start action when PWM counter down count to zero if this bit is set to1.
     * |        |          |0 = PWM period point trigger DAC function Disabled.
     * |        |          |1 = PWM period point trigger DAC function Enabled.
     * |[4]     |ZTE4      |PWM Zero Point Trigger DAC Enable Bit 4
     * |        |          |PWM can trigger EADC/DAC/DMA to start action when PWM counter down count to zero if this bit is set to1.
     * |        |          |0 = PWM period point trigger DAC function Disabled.
     * |        |          |1 = PWM period point trigger DAC function Enabled.
     * |[8]     |PTE0      |PWM Period Point Trigger DAC Enable Bit 0
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to (PERIODn+1) if this bit is set to1.
     * |        |          |0 = PWM period point trigger DAC function Disabled.
     * |        |          |1 = PWM period point trigger DAC function Enabled.
     * |[10]    |PTE2      |PWM Period Point Trigger DAC Enable Bit 2
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to (PERIODn+1) if this bit is set to1.
     * |        |          |0 = PWM period point trigger DAC function Disabled.
     * |        |          |1 = PWM period point trigger DAC function Enabled.
     * |[12]    |PTE4      |PWM Period Point Trigger DAC Enable Bit 4
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to (PERIODn+1) if this bit is set to1.
     * |        |          |0 = PWM period point trigger DAC function Disabled.
     * |        |          |1 = PWM period point trigger DAC function Enabled.
     * |[16]    |CUTRGEN0  |PWM Compare Up Count Point Trigger DAC Enable Bits
     ...
     * |[17]    |CUTRGEN1  |PWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[18]    |CUTRGEN2  |PWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[19]    |CUTRGEN3  |PWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[20]    |CUTRGEN4  |PWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[21]    |CUTRGEN5  |PWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[24]    |CDTRGEN0  |PWM Compare Down Count Point Trigger DAC Enable Bits
     ...
     * |[25]    |CDTRGEN1  |PWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[26]    |CDTRGEN2  |PWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[27]    |CDTRGEN3  |PWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[28]    |CDTRGEN4  |PWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[29]    |CDTRGEN5  |PWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |PWM can trigger DAC to start action when PWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = PWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = PWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when PWM counter operating in up counter type.
     ...
     * |        |          |1 = An EADC start of conversion trigger event has occurred.
     * |        |          |Note: This bit can be cleared by software writing 1.
     * |[23]    |LPADCTRG  |LPADC Start of Conversion Status
     * |        |          |0 = Indicates no LPADC start of conversion trigger event has occurred.
     * |        |          |1 = An LPADC start of conversion trigger event has occurred.
     * |        |          |Note: This bit can be cleared by software writing 1.
     ...
     * |        |          |Note: This bit can be cleared by software writing 1.
     * @var PWM_T::IFA[6]
     * Offset: 0x130, 0x138, 0x140  PWM Interrupt Flag Accumulator Register 0/2/4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note: This bit will be cleared automatically when user clear corresponding CFLIF.
     * @var PWM_T::CAPDAT[6]
     * Offset: 0x20C,0x214,0x21C,0x224,0x22C,0x234  PWM Rising Capture Data Register 0~5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |RCAPDAT   |PWM Rising Capture Data Register (Read Only)
     * |        |          |When rising capture condition happened, the PWM counter value will be saved in this register.
     * Offset: 0x210,0x218,0x220,0x228,0x230,0x238  PWM Falling Capture Data Register 0~5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note: If the PDMA function is not supported, this bit field will become invalid.
     * @var PWM_T::PDMACAP[3]
     * Offset: 0x240~0x248  PWM Capture Channel 0_1,2_3,4_5 PDMA Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note 2: This bit is cleared by writing 1 to it.
     * @var PWM_T::CAPNF
     * Offset: 0x258~0x26c  PWM Capture Input Noise Filter Register 0
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable Bit
     ...
     * @var PWM_T::EXTETCTL
     * Offset: 0x270~0x280  PWM External Event Trigger Control Register 0
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note: This bit will auto cleared by hardware.
     * @var PWM_T::PBUF
     * Offset: 0x304~0x318  PWM PERIOD Buffer 0/2/4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var PWM_T::CMPBUF
     * Offset: 0x31C~~0x330  PWM CMPDAT Buffer 0~5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
    ...
    __IO uint32_t CLKPSC[3];             /*!< [0x0014~0x001c] PWM Clock Pre-scale Register 0_1, 2_3, 4_5                */
    __IO uint32_t CNTEN;                 /*!< [0x0020] PWM Counter Enable Register                                      */
    __IO uint32_t CNTCLR;                /*!< [0x0024] PWM Clear Counter Register                                       */
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE1[2];
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t PERIOD[6];             /*!< [0x0030~0x0044,0x30,0x38,0x40 used] PWM Period Register 0/2/4                                 */
    /// @cond HIDDEN_SYMBOLS
    ...
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t DTCTL[3];              /*!< [0x0070~0x0078] PWM Dead-Time Control Register 0_1, 2_3, 4_5               */
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE4[5];
    /// @endcond //HIDDEN_SYMBOLS
    __I  uint32_t CNT[6];                /*!< [0x0090~0x00a4,0x90,0x98,0xa0 used] PWM Counter Register 0/2/4                                */
    /// @cond HIDDEN_SYMBOLS
    ...
    __IO uint32_t BRKCTL[3];             /*!< [0x00c8~0x00d0] PWM Brake Edge Detect Control Register 0_1, 2_3, 4_5               */
    ...
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t IFA[6];                  /*!< [0x0130~0x0144,0x130,0x138,0x140 used] PWM Interrupt Flag Accumulator Register 0/2/4                        */
    /// @cond HIDDEN_SYMBOLS
    ...
    CAPDAT_T CAPDAT[6];                  /*!< [0x020C~0x0238] PWM Rising and Falling Capture Data Register 0~5                */
    __IO uint32_t PDMACTL;               /*!< [0x023c] PWM PDMA Control Register                                        */
    __I  uint32_t PDMACAP[3];            /*!< [0x0240~0x0248] PWM Capture Channel 0_1,2_3,4_5 PDMA Register                             */
    /// @cond HIDDEN_SYMBOLS
    ...
    __IO uint32_t CAPNF[6];                /*!< [0x0258~0x026c] PWM Capture Input Noise Filter Register 0~5                        */
    __IO uint32_t EXTETCTL[6];             /*!< [0x0270~0x0284] PWM External Event Trigger Control Register 0/2/4        */
    ...
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE13[29];
    /// @endcond //HIDDEN_SYMBOLS
    __I  uint32_t PBUF[6];                 /*!< [0x0304~0x0318,0x304,0x30C,0x314 used] PWM PERIOD Buffer 0/2/4                                      */
    __I  uint32_t CMPBUF[6];               /*!< [0x031c~0x0330] PWM CMPDAT Buffer 0~5                                        */
} PWM_T;
...
#define PWM_CTL1_PWMMODE0_Pos            (24)                                              /*!< PWM_T::CTL1: PWMMODE0 Position         */
#define PWM_CTL1_PWMMODE0_Msk            (0x1ul << PWM_CTL1_PWMMODE0_Pos)                  /*!< PWM_T::CTL1: PWMMODE0 Mask             */

#define PWM_CTL1_PWMMODE2_Pos            (25)                                              /*!< PWM_T::CTL1: PWMMODE2 Position         */
#define PWM_CTL1_PWMMODE2_Msk            (0x1ul << PWM_CTL1_PWMMODE2_Pos)                  /*!< PWM_T::CTL1: PWMMODE2 Mask             */

#define PWM_CTL1_PWMMODE4_Pos            (26)                                              /*!< PWM_T::CTL1: PWMMODE4 Position         */
#define PWM_CTL1_PWMMODE4_Msk            (0x1ul << PWM_CTL1_PWMMODE4_Pos)                  /*!< PWM_T::CTL1: PWMMODE4 Mask             */
...
#define PWM_FAILBRK_FLASHBRKEN_Pos       (4)                                               /*!< PWM_T::FAILBRK: FLASHBRKEN Position      */
#define PWM_FAILBRK_FLASHBRKEN_Msk       (0x1ul << PWM_FAILBRK_FLASHBRKEN_Pos)               /*!< PWM_T::FAILBRK: FLASHBRKEN Mask          */

#define PWM_FAILBRK_NSRAMBRKEN_Pos       (5)                                               /*!< PWM_T::FAILBRK: NSRAMBRKEN Position      */
#define PWM_FAILBRK_NSRAMBRKEN_Msk       (0x1ul << PWM_FAILBRK_NSRAMBRKEN_Pos)               /*!< PWM_T::FAILBRK: NSRAMBRKEN Mask          */

#define PWM_FAILBRK_NSFLASHBRKEN_Pos     (6)                                               /*!< PWM_T::FAILBRK: NSFLASHBRKEN Position      */
#define PWM_FAILBRK_NSFLASHBRKEN_Msk     (0x1ul << PWM_FAILBRK_NSFLASHBRKEN_Pos)               /*!< PWM_T::FAILBRK: NSFLASHBRKEN Mask          */
...
#define PWM_BRKCTL_EADC0EBEN_Pos      (20)                                              /*!< PWM_T::BRKCTL: EADC0EBEN Position   */
#define PWM_BRKCTL_EADC0EBEN_Msk      (0x1ul << PWM_BRKCTL_EADC0EBEN_Pos)            /*!< PWM_T::BRKCTL: EADC0EBEN Mask       */

#define PWM_BRKCTL_EADC1EBEN_Pos      (21)                                              /*!< PWM_T::BRKCTL: EADC1EBEN Position   */
#define PWM_BRKCTL_EADC1EBEN_Msk      (0x1ul << PWM_BRKCTL_EADC1EBEN_Pos)            /*!< PWM_T::BRKCTL: EADC1EBEN Mask       */

#define PWM_BRKCTL_EADC0LBEN_Pos      (28)                                              /*!< PWM_T::BRKCTL: EADC0LBEN Position   */
#define PWM_BRKCTL_EADC0LBEN_Msk      (0x1ul << PWM_BRKCTL_EADC0LBEN_Pos)            /*!< PWM_T::BRKCTL: EADC0LBEN Mask       */

#define PWM_BRKCTL_EADC1LBEN_Pos      (29)                                              /*!< PWM_T::BRKCTL: EADC1LBEN Position   */
#define PWM_BRKCTL_EADC1LBEN_Msk      (0x1ul << PWM_BRKCTL_EADC1LBEN_Pos)            /*!< PWM_T::BRKCTL: EADC1LBEN Mask       */
...
#define PWM_BRKCTL0_1_EADC0EBEN_Pos      (20)                                              /*!< PWM_T::BRKCTL0_1: EADC0EBEN Position   */
#define PWM_BRKCTL0_1_EADC0EBEN_Msk      (0x1ul << PWM_BRKCTL0_1_EADC0EBEN_Pos)            /*!< PWM_T::BRKCTL0_1: EADC0EBEN Mask       */

#define PWM_BRKCTL0_1_EADC0LBEN_Pos      (28)                                              /*!< PWM_T::BRKCTL0_1: EADC0LBEN Position   */
#define PWM_BRKCTL0_1_EADC0LBEN_Msk      (0x1ul << PWM_BRKCTL0_1_EADC0LBEN_Pos)            /*!< PWM_T::BRKCTL0_1: EADC0LBEN Mask       */
...
#define PWM_BRKCTL2_3_EADC0EBEN_Pos      (20)                                              /*!< PWM_T::BRKCTL2_3: EADC0EBEN Position   */
#define PWM_BRKCTL2_3_EADC0EBEN_Msk      (0x1ul << PWM_BRKCTL2_3_EADC0EBEN_Pos)            /*!< PWM_T::BRKCTL2_3: EADC0EBEN Mask       */

#define PWM_BRKCTL2_3_EADC0LBEN_Pos      (28)                                              /*!< PWM_T::BRKCTL2_3: EADC0LBEN Position   */
#define PWM_BRKCTL2_3_EADC0LBEN_Msk      (0x1ul << PWM_BRKCTL2_3_EADC0LBEN_Pos)            /*!< PWM_T::BRKCTL2_3: EADC0LBEN Mask       */
...
#define PWM_BRKCTL4_5_EADC0EBEN_Pos      (20)                                              /*!< PWM_T::BRKCTL4_5: EADC0EBEN Position   */
#define PWM_BRKCTL4_5_EADC0EBEN_Msk      (0x1ul << PWM_BRKCTL4_5_EADC0EBEN_Pos)            /*!< PWM_T::BRKCTL4_5: EADC0EBEN Mask       */

#define PWM_BRKCTL4_5_EADC0LBEN_Pos      (28)                                              /*!< PWM_T::BRKCTL4_5: EADC0LBEN Position   */
#define PWM_BRKCTL4_5_EADC0LBEN_Msk      (0x1ul << PWM_BRKCTL4_5_EADC0LBEN_Pos)            /*!< PWM_T::BRKCTL4_5: EADC0LBEN Mask       */
...
#define PWM_DACTRGEN_CUTRGEN0_Pos        (16)                                              /*!< PWM_T::DACTRGEN: CUTRGEN0 Position     */
#define PWM_DACTRGEN_CUTRGEN0_Msk        (0x1ul << PWM_DACTRGEN_CUTRGEN0_Pos)              /*!< PWM_T::DACTRGEN: CUTRGEN0 Mask         */

#define PWM_DACTRGEN_CUTRGEN1_Pos        (17)                                              /*!< PWM_T::DACTRGEN: CUTRGEN1 Position     */
#define PWM_DACTRGEN_CUTRGEN1_Msk        (0x1ul << PWM_DACTRGEN_CUTRGEN1_Pos)              /*!< PWM_T::DACTRGEN: CUTRGEN1 Mask         */

#define PWM_DACTRGEN_CUTRGEN2_Pos        (18)                                              /*!< PWM_T::DACTRGEN: CUTRGEN2 Position     */
#define PWM_DACTRGEN_CUTRGEN2_Msk        (0x1ul << PWM_DACTRGEN_CUTRGEN2_Pos)              /*!< PWM_T::DACTRGEN: CUTRGEN2 Mask         */

#define PWM_DACTRGEN_CUTRGEN3_Pos        (19)                                              /*!< PWM_T::DACTRGEN: CUTRGEN3 Position     */
#define PWM_DACTRGEN_CUTRGEN3_Msk        (0x1ul << PWM_DACTRGEN_CUTRGEN3_Pos)              /*!< PWM_T::DACTRGEN: CUTRGEN3 Mask         */

#define PWM_DACTRGEN_CUTRGEN4_Pos        (20)                                              /*!< PWM_T::DACTRGEN: CUTRGEN4 Position     */
#define PWM_DACTRGEN_CUTRGEN4_Msk        (0x1ul << PWM_DACTRGEN_CUTRGEN4_Pos)              /*!< PWM_T::DACTRGEN: CUTRGEN4 Mask         */

#define PWM_DACTRGEN_CUTRGEN5_Pos        (21)                                              /*!< PWM_T::DACTRGEN: CUTRGEN5 Position     */
#define PWM_DACTRGEN_CUTRGEN5_Msk        (0x1ul << PWM_DACTRGEN_CUTRGEN5_Pos)              /*!< PWM_T::DACTRGEN: CUTRGEN5 Mask         */

#define PWM_DACTRGEN_CDTRGEN0_Pos        (24)                                              /*!< PWM_T::DACTRGEN: CDTRGEN0 Position     */
#define PWM_DACTRGEN_CDTRGEN0_Msk        (0x1ul << PWM_DACTRGEN_CDTRGEN0_Pos)              /*!< PWM_T::DACTRGEN: CDTRGEN0 Mask         */

#define PWM_DACTRGEN_CDTRGEN1_Pos        (25)                                              /*!< PWM_T::DACTRGEN: CDTRGEN1 Position     */
#define PWM_DACTRGEN_CDTRGEN1_Msk        (0x1ul << PWM_DACTRGEN_CDTRGEN1_Pos)              /*!< PWM_T::DACTRGEN: CDTRGEN1 Mask         */

#define PWM_DACTRGEN_CDTRGEN2_Pos        (26)                                              /*!< PWM_T::DACTRGEN: CDTRGEN2 Position     */
#define PWM_DACTRGEN_CDTRGEN2_Msk        (0x1ul << PWM_DACTRGEN_CDTRGEN2_Pos)              /*!< PWM_T::DACTRGEN: CDTRGEN2 Mask         */

#define PWM_DACTRGEN_CDTRGEN3_Pos        (27)                                              /*!< PWM_T::DACTRGEN: CDTRGEN3 Position     */
#define PWM_DACTRGEN_CDTRGEN3_Msk        (0x1ul << PWM_DACTRGEN_CDTRGEN3_Pos)              /*!< PWM_T::DACTRGEN: CDTRGEN3 Mask         */

#define PWM_DACTRGEN_CDTRGEN4_Pos        (28)                                              /*!< PWM_T::DACTRGEN: CDTRGEN4 Position     */
#define PWM_DACTRGEN_CDTRGEN4_Msk        (0x1ul << PWM_DACTRGEN_CDTRGEN4_Pos)              /*!< PWM_T::DACTRGEN: CDTRGEN4 Mask         */

#define PWM_DACTRGEN_CDTRGEN5_Pos        (29)                                              /*!< PWM_T::DACTRGEN: CDTRGEN5 Position     */
#define PWM_DACTRGEN_CDTRGEN5_Msk        (0x1ul << PWM_DACTRGEN_CDTRGEN5_Pos)              /*!< PWM_T::DACTRGEN: CDTRGEN5 Mask         */
...
#define PWM_CAPNF_CAPNFEN_Pos           (0)                                               /*!< PWM_T::CAPNF: CAPNFEN Position        */
#define PWM_CAPNF_CAPNFEN_Msk           (0x1ul << PWM_CAPNF_CAPNFEN_Pos)                 /*!< PWM_T::CAPNF: CAPNFEN Mask            */

#define PWM_CAPNF_CAPNFSEL_Pos          (4)                                               /*!< PWM_T::CAPNF: CAPNFSEL Position       */
#define PWM_CAPNF_CAPNFSEL_Msk          (0x7ul << PWM_CAPNF_CAPNFSEL_Pos)                /*!< PWM_T::CAPNF: CAPNFSEL Mask           */

#define PWM_CAPNF_CAPNFCNT_Pos          (8)                                               /*!< PWM_T::CAPNF: CAPNFCNT Position       */
#define PWM_CAPNF_CAPNFCNT_Msk          (0x7ul << PWM_CAPNF_CAPNFCNT_Pos)                /*!< PWM_T::CAPNF: CAPNFCNT Mask           */
...
#define PWM_EXTETCTL_EXTETEN_Pos        (0)                                               /*!< PWM_T::EXTETCTL: EXTETEN Position     */
#define PWM_EXTETCTL_EXTETEN_Msk        (0x1ul << PWM_EXTETCTL_EXTETEN_Pos)              /*!< PWM_T::EXTETCTL: EXTETEN Mask         */

#define PWM_EXTETCTL_CNTACTS_Pos        (4)                                               /*!< PWM_T::EXTETCTL: CNTACTS Position     */
#define PWM_EXTETCTL_CNTACTS_Msk        (0x3ul << PWM_EXTETCTL_CNTACTS_Pos)              /*!< PWM_T::EXTETCTL: CNTACTS Mask         */

#define PWM_EXTETCTL_EXTTRGS_Pos        (8)                                               /*!< PWM_T::EXTETCTL: EXTTRGS Position     */
#define PWM_EXTETCTL_EXTTRGS_Msk        (0xful << PWM_EXTETCTL_EXTTRGS_Pos)              /*!< PWM_T::EXTETCTL: EXTTRGS Mask         */
