...
typedef struct
{
     ...
     * |        |          |The delayed clock cycle is 1024 clock cycles when chip works using HXT, and 256 or 128 clock cycles when chip works using HIRC.
     ...
     * |        |          |00 = HIRC stable count is 1024 clocks.
     * |        |          |01 = HIRC stable count is 512 clocks.
     * |        |          |Others = Reserved.
     ...
     * |        |          |000 = HXT frequency is from 1 MHz to 4 MHz. (ESR=45ohm ; CLFXT =12.5pF).
     * |        |          |001 = HXT frequency is from 4 MHz to 8 MHz. (ESR=15ohm ; CLFXT =12.5pF).
     * |        |          |010 = HXT frequency is from 8 MHz to 12 MHz. (ESR=10ohm ; CLFXT =12.5pF).
     * |        |          |011 = HXT frequency is from 12 MHz to 16 MHz. (ESR=8.8ohm ; CLFXT =12.5pF).
     * |        |          |100 = HXT frequency is from 16 MHz to 24 MHz. (ESR=7.5ohm ; CLFXT =12.5pF).
     * |        |          |101 = HXT frequency is from 24 MHz to 32 MHz. (ESR=7.5ohm ; CLFXT =12.5pF).
     * |        |          |others = HXT frequency is from 8 MHz to 12 MHz. (ESR=15ohm ; CLFXT =12.5pF).
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     ...
     * |[14]    |DFMCCKEN  |DFMC Clock Enable Bit
     * |        |          |0 = DFMC clock Disabled.
     * |        |          |1 = DFMC clock Enabled.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |WDT0CKEN  |Watchdog Timer 0 Clock Enable Bit (Write Protect)
     ...
     * |[22]    |UART8CKEN |UART8 Clock Enable Bit
     * |        |          |0 = UART8 clock Disabled.
     * |        |          |1 = UART8 clock Enabled.
     * |[23]    |UART9CKEN |UART9 Clock Enable Bit
     ...
     * |[31]    |WDT1CKEN  |Watchdog Timer 1 Clock Enable Bit (Write Protect)
     ...
     * |[21]    |EQEI1CKEN |EQEI1 Clock Enable Bit
     * |        |          |0 = EQEI1 clock Disabled.
     * |        |          |1 = EQEI1 clock Enabled.
     * |[24]    |UART6CKEN |UART6 Clock Enable Bit
     * |        |          |0 = UART6 clock Disabled.
     * |        |          |1 = UART6 clock Enabled.
     * |[25]    |UART7CKEN |UART7 Clock Enable Bit
     ...
     * |        |          |SYST_CTRL[2] = 0), SysTick needs to enable STCKEN(CLK_AHBCLK0[4])
     ...
     * |        |          |1 = Clock source from PLL.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     * |[11]    |EADC1SEL  |EADC1 Clock Source Selection (Write Protect)
     * |        |          |0 = Clock source from HCLK.
     * |        |          |1 = Clock source from PLL.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     ...
     * |        |          |11 = Clock source from LIRC.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     * |[6:4]   |CLKOSEL   |Clock Output Clock Source Selection (Write Protect)
     * |        |          |000 = Clock source from HXT.
     * |        |          |001 = Clock source from LXT.
     ...
     * |        |          |10 = Clock source from LXT.
     * |        |          |11 = Clock source from HIRC.
     * |[29:28] |WWDT0SEL  |Window Watchdog Timer 0 Clock Source Selection (Write Protect)
     * |        |          |10 = Clock source from HCLK/2048.
     * |        |          |11 = Clock source from LIRC.
     * |        |          |Others = Reserved.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     * |[31:30] |WWDT1SEL  |Window Watchdog Timer 1 Clock Source Selection (Write Protect)
     * |        |          |10 = Clock source from HCLK/2048.
     * |        |          |11 = Clock source from LIRC.
     * |        |          |Others = Reserved.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[13:12] |UART6SEL  |UART6 Clock Source Selection
     * |        |          |00 = Clock source from HXT.
     * |        |          |01 = Clock source from PLL.
     * |        |          |10 = Clock source from LXT.
     * |        |          |11 = Clock source from HIRC.
     * |[15:14] |UART7SEL  |UART7 Clock Source Selection
     * |        |          |00 = Clock source from HXT.
     * |        |          |01 = Clock source from PLL.
     * |        |          |10 = Clock source from LXT.
     * |        |          |11 = Clock source from HIRC.
     * |[18]    |I3C0SEL   |I3C0 Clock Source Selection
     * |        |          |0 = Clock source from HCLK.
     * |        |          |1 = Clock source from PLL.
     ...
     * |[19:16] |CANFD0DIV |CANFD0 Clock Divide Number from CANFD0 Clock Source
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[3:0]   |UART5DIV  |UART5 Clock Divide Number from UART5 Clock Source
     * |        |          |UART5 clock frequency = (UART5 clock source frequency) / (UART5DIV + 1).
     * |[7:4]   |UART8DIV  |UART8 Clock Divide Number from UART8 Clock Source
     * |        |          |UART8 clock frequency = (UART8 clock source frequency) / (UART8DIV + 1).
     * |[11:8]  |UART9DIV  |UART9 Clock Divide Number from UART9 Clock Source
     * |        |          |UART9 clock frequency = (UART9 clock source frequency) / (UART9DIV + 1).
     * |[15:12] |UART6DIV  |UART6 Clock Divide Number from UART6 Clock Source
     * |        |          |UART6 clock frequency = (UART6 clock source frequency) / (UART6DIV + 1).
     * |[19:16] |UART7DIV  |UART7 Clock Divide Number from UART7 Clock Source
     ...
     * |[11]    |ELLSI1CKEN|ELLSI1 Clock Enable Bit
     * |        |          |0 = ELLSI1 clock Disabled.
     * |        |          |1 = ELLSI1 clock Enabled.
     * |[25]    |TRNGCKEN  |TRNG Clock Enable
     * |        |          |0 = TRNG clock Disable.
     * |        |          |1 = TRNG clock Enable.
     * @var CLK_T::PLLCTL
     ...
     * |        |          |0 = PLL stable time is 2400 PLL source clock (suitable for source clock equal to or less than 12 MHz).
     * |        |          |1 = PLL stable time is 6400 PLL source clock (suitable for source clock larger than 12 MHz).
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     * @var CLK_T::STATUS
     ...
     * |        |          |1 = 32.768 kHz external low speed crystal oscillator (LXT) clock stops.
     * |        |          |Note 1: Write 1 to clear the bit to 0.
     * |        |          |Note 2: This bit is write protected. Refer to the SYS_REGLCTL register.
     ...
     * |        |          |000 = Normal Power-down mode is selected (NPD1).
     * |        |          |001 = Low leakage Power-down mode is selected (NPD2).
     * |        |          |010 = Fast wake-up Power-down mode is selected (NPD0).
     * |        |          |011 = Reserved.
     * |        |          |100 = Standby Power-down mode is selected (SPD0).
     * |        |          |101 = Low leakage Standby Power-down mode is selected (SPD1).
     * |        |          |110 = Reserved.
     * |        |          |111 = Reserved.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     ...
     * |        |          |SRETSEL[0] = Bank0 SRAM retention when chip enter SPD mode.
     * |        |          |1: SPD retention
     * |        |          |0: SPD no retention
     ...
     * |        |          |0 = Wake-up timer disabled at SPD mode.
     * |        |          |1 = Wake-up timer enabled at SPD mode.
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     ...
     * |        |          |0 = VBUS transition wake-up disabled at Standby Power-down mode.
     * |        |          |1 = VBUS transition wake-up enabled at Standby Power-down mode.
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     ...
     * |        |          |This flag indicates that wake-up of chip from Standby Power-down (SPD) mode was requested by wakeup timer time-out.
     ...
     * |        |          |This flag indicates that wakeup of device from Standby Power-down (SPD) mode was requested with a RTC alarm, tick time or tamper happened.
     * |        |          |Note: This flag needs to be cleared by setting CLRWK(CLK_PMUSTS[31] when entering SPD mode.
     ...
     * |        |          |This flag indicates that wakeup of device from Standby Power-down (SPD) mode was requested with a RST pin trigger happened.
     * |        |          |Note: This flag needs to be cleared by setting CLRWK(CLK_PMUSTS[31] when entering SPD mode.
     ...
     * |        |          |When GPIO enters standby power-down mode, all I/O status will turn to input floating status
     * |        |          |After chip is woken up from standby power-down mode, the I/O are still keep input floating status until user set this bit to release I/O hold status.
     * |        |          |Note: This bit is auto cleared by hardware.
     * @var CLK_T::PMUINTC
...
#define CLK_AHBCLK0_DFMCCKEN_Pos         (14)                                              /*!< CLK_T::AHBCLK0: DFMCCKEN Position      */
#define CLK_AHBCLK0_DFMCCKEN_Msk         (0x1ul << CLK_AHBCLK0_DFMCCKEN_Pos)               /*!< CLK_T::AHBCLK0: DFMCCKEN Mask          */
...
#define CLK_APBCLK0_UART8CKEN_Pos        (22)                                              /*!< CLK_T::APBCLK0: UART8CKEN Position     */
#define CLK_APBCLK0_UART8CKEN_Msk        (0x1ul << CLK_APBCLK0_UART8CKEN_Pos)              /*!< CLK_T::APBCLK0: UART8CKEN Mask         */

#define CLK_APBCLK0_UART9CKEN_Pos        (23)                                              /*!< CLK_T::APBCLK0: UART9CKEN Position     */
...
#define CLK_APBCLK1_EQEI1CKEN_Pos        (21)                                              /*!< CLK_T::APBCLK1: EQEI1CKEN Position     */
#define CLK_APBCLK1_EQEI1CKEN_Msk        (0x1ul << CLK_APBCLK1_EQEI1CKEN_Pos)              /*!< CLK_T::APBCLK1: EQEI1CKEN Mask         */

#define CLK_APBCLK1_UART6CKEN_Pos        (24)                                              /*!< CLK_T::APBCLK1: UART6CKEN Position     */
#define CLK_APBCLK1_UART6CKEN_Msk        (0x1ul << CLK_APBCLK1_UART6CKEN_Pos)              /*!< CLK_T::APBCLK1: UART6CKEN Mask         */

#define CLK_APBCLK1_UART7CKEN_Pos        (25)                                              /*!< CLK_T::APBCLK1: UART7CKEN Position     */
#define CLK_APBCLK1_UART7CKEN_Msk        (0x1ul << CLK_APBCLK1_UART7CKEN_Pos)              /*!< CLK_T::APBCLK1: UART7CKEN Mask         */
...
#define CLK_CLKSEL0_EADC1SEL_Pos         (11)                                              /*!< CLK_T::CLKSEL0: EADC1SEL Position      */
#define CLK_CLKSEL0_EADC1SEL_Msk         (0x1ul << CLK_CLKSEL0_EADC1SEL_Pos)               /*!< CLK_T::CLKSEL0: EADC1SEL Mask          */
...
#define CLK_CLKSEL3_UART6SEL_Pos         (12)                                              /*!< CLK_T::CLKSEL3: UART6SEL Position      */
#define CLK_CLKSEL3_UART6SEL_Msk         (0x3ul << CLK_CLKSEL3_UART6SEL_Pos)               /*!< CLK_T::CLKSEL3: UART6SEL Mask          */

#define CLK_CLKSEL3_UART7SEL_Pos         (14)                                              /*!< CLK_T::CLKSEL3: UART7SEL Position      */
...
#define CLK_CLKSEL3_I3C0SEL_Msk          (0x1ul << CLK_CLKSEL3_I3C0SEL_Pos)                /*!< CLK_T::CLKSEL3: I3C0SEL Mask           */

#define CLK_CLKSEL3_UART8SEL_Pos         (20)                                              /*!< CLK_T::CLKSEL3: UART8SEL Position      */
#define CLK_CLKSEL3_UART8SEL_Msk         (0x3ul << CLK_CLKSEL3_UART8SEL_Pos)               /*!< CLK_T::CLKSEL3: UART8SEL Mask          */

#define CLK_CLKSEL3_UART9SEL_Pos         (22)                                              /*!< CLK_T::CLKSEL3: UART9SEL Position      */
...
#define CLK_APBCLK2_ELLSI1CKEN_Pos       (11)                                              /*!< CLK_T::APBCLK2: ELLSI1CKEN Position    */
#define CLK_APBCLK2_ELLSI1CKEN_Msk       (0x1ul << CLK_APBCLK2_ELLSI1CKEN_Pos)             /*!< CLK_T::APBCLK2: ELLSI1CKEN Mask        */

#define CLK_APBCLK2_TRNGCKEN_Pos         (25)                                              /*!< CLK_T::APBCLK2: TRNGCKEN Position      */
#define CLK_APBCLK2_TRNGCKEN_Msk         (0x1ul << CLK_APBCLK2_TRNGCKEN_Pos)               /*!< CLK_T::APBCLK2: TRNGCKEN Mask          */
...
#define CLK_PASWKCTL_WKEN0_Pos           (0)                                               /*!< CLK_T::PASWKCTL: WKEN0 Position        */
#define CLK_PASWKCTL_WKEN0_Msk           (0x1ul << CLK_PASWKCTL_WKEN0_Pos)                 /*!< CLK_T::PASWKCTL: WKEN0 Mask            */

#define CLK_PASWKCTL_PRWKEN0_Pos         (1)                                               /*!< CLK_T::PASWKCTL: PRWKEN0 Position      */
#define CLK_PASWKCTL_PRWKEN0_Msk         (0x1ul << CLK_PASWKCTL_PRWKEN0_Pos)               /*!< CLK_T::PASWKCTL: PRWKEN0 Mask          */

#define CLK_PASWKCTL_PFWKEN0_Pos         (2)                                               /*!< CLK_T::PASWKCTL: PFWKEN0 Position      */
#define CLK_PASWKCTL_PFWKEN0_Msk         (0x1ul << CLK_PASWKCTL_PFWKEN0_Pos)               /*!< CLK_T::PASWKCTL: PFWKEN0 Mask          */

#define CLK_PASWKCTL_WKPSEL0_Pos         (4)                                               /*!< CLK_T::PASWKCTL: WKPSEL0 Position      */
#define CLK_PASWKCTL_WKPSEL0_Msk         (0xful << CLK_PASWKCTL_WKPSEL0_Pos)               /*!< CLK_T::PASWKCTL: WKPSEL0 Mask          */

#define CLK_PASWKCTL_DBEN0_Pos           (8)                                               /*!< CLK_T::PASWKCTL: DBEN0 Position        */
#define CLK_PASWKCTL_DBEN0_Msk           (0x1ul << CLK_PASWKCTL_DBEN0_Pos)                 /*!< CLK_T::PASWKCTL: DBEN0 Mask            */

#define CLK_PASWKCTL_WKEN1_Pos           (16)                                              /*!< CLK_T::PASWKCTL: WKEN1 Position        */
#define CLK_PASWKCTL_WKEN1_Msk           (0x1ul << CLK_PASWKCTL_WKEN1_Pos)                 /*!< CLK_T::PASWKCTL: WKEN1 Mask            */

#define CLK_PASWKCTL_PRWKEN1_Pos         (17)                                              /*!< CLK_T::PASWKCTL: PRWKEN1 Position      */
#define CLK_PASWKCTL_PRWKEN1_Msk         (0x1ul << CLK_PASWKCTL_PRWKEN1_Pos)               /*!< CLK_T::PASWKCTL: PRWKEN1 Mask          */

#define CLK_PASWKCTL_PFWKEN1_Pos         (18)                                              /*!< CLK_T::PASWKCTL: PFWKEN1 Position      */
#define CLK_PASWKCTL_PFWKEN1_Msk         (0x1ul << CLK_PASWKCTL_PFWKEN1_Pos)               /*!< CLK_T::PASWKCTL: PFWKEN1 Mask          */

#define CLK_PASWKCTL_WKPSEL1_Pos         (20)                                              /*!< CLK_T::PASWKCTL: WKPSEL1 Position      */
#define CLK_PASWKCTL_WKPSEL1_Msk         (0xful << CLK_PASWKCTL_WKPSEL1_Pos)               /*!< CLK_T::PASWKCTL: WKPSEL1 Mask          */

#define CLK_PASWKCTL_DBEN1_Pos           (24)                                              /*!< CLK_T::PASWKCTL: DBEN1 Position        */
#define CLK_PASWKCTL_DBEN1_Msk           (0x1ul << CLK_PASWKCTL_DBEN1_Pos)                 /*!< CLK_T::PASWKCTL: DBEN1 Mask            */

#define CLK_PBSWKCTL_WKEN0_Pos           (0)                                               /*!< CLK_T::PBSWKCTL: WKEN0 Position        */
#define CLK_PBSWKCTL_WKEN0_Msk           (0x1ul << CLK_PBSWKCTL_WKEN0_Pos)                 /*!< CLK_T::PBSWKCTL: WKEN0 Mask            */

#define CLK_PBSWKCTL_PRWKEN0_Pos         (1)                                               /*!< CLK_T::PBSWKCTL: PRWKEN0 Position      */
#define CLK_PBSWKCTL_PRWKEN0_Msk         (0x1ul << CLK_PBSWKCTL_PRWKEN0_Pos)               /*!< CLK_T::PBSWKCTL: PRWKEN0 Mask          */

#define CLK_PBSWKCTL_PFWKEN0_Pos         (2)                                               /*!< CLK_T::PBSWKCTL: PFWKEN0 Position      */
#define CLK_PBSWKCTL_PFWKEN0_Msk         (0x1ul << CLK_PBSWKCTL_PFWKEN0_Pos)               /*!< CLK_T::PBSWKCTL: PFWKEN0 Mask          */

#define CLK_PBSWKCTL_WKPSEL0_Pos         (4)                                               /*!< CLK_T::PBSWKCTL: WKPSEL0 Position      */
#define CLK_PBSWKCTL_WKPSEL0_Msk         (0xful << CLK_PBSWKCTL_WKPSEL0_Pos)               /*!< CLK_T::PBSWKCTL: WKPSEL0 Mask          */

#define CLK_PBSWKCTL_DBEN0_Pos           (8)                                               /*!< CLK_T::PBSWKCTL: DBEN0 Position        */
#define CLK_PBSWKCTL_DBEN0_Msk           (0x1ul << CLK_PBSWKCTL_DBEN0_Pos)                 /*!< CLK_T::PBSWKCTL: DBEN0 Mask            */

#define CLK_PBSWKCTL_WKEN1_Pos           (16)                                              /*!< CLK_T::PBSWKCTL: WKEN1 Position        */
#define CLK_PBSWKCTL_WKEN1_Msk           (0x1ul << CLK_PBSWKCTL_WKEN1_Pos)                 /*!< CLK_T::PBSWKCTL: WKEN1 Mask            */

#define CLK_PBSWKCTL_PRWKEN1_Pos         (17)                                              /*!< CLK_T::PBSWKCTL: PRWKEN1 Position      */
#define CLK_PBSWKCTL_PRWKEN1_Msk         (0x1ul << CLK_PBSWKCTL_PRWKEN1_Pos)               /*!< CLK_T::PBSWKCTL: PRWKEN1 Mask          */

#define CLK_PBSWKCTL_PFWKEN1_Pos         (18)                                              /*!< CLK_T::PBSWKCTL: PFWKEN1 Position      */
#define CLK_PBSWKCTL_PFWKEN1_Msk         (0x1ul << CLK_PBSWKCTL_PFWKEN1_Pos)               /*!< CLK_T::PBSWKCTL: PFWKEN1 Mask          */

#define CLK_PBSWKCTL_WKPSEL1_Pos         (20)                                              /*!< CLK_T::PBSWKCTL: WKPSEL1 Position      */
#define CLK_PBSWKCTL_WKPSEL1_Msk         (0xful << CLK_PBSWKCTL_WKPSEL1_Pos)               /*!< CLK_T::PBSWKCTL: WKPSEL1 Mask          */

#define CLK_PBSWKCTL_DBEN1_Pos           (24)                                              /*!< CLK_T::PBSWKCTL: DBEN1 Position        */
#define CLK_PBSWKCTL_DBEN1_Msk           (0x1ul << CLK_PBSWKCTL_DBEN1_Pos)                 /*!< CLK_T::PBSWKCTL: DBEN1 Mask            */

#define CLK_PCSWKCTL_WKEN0_Pos           (0)                                               /*!< CLK_T::PCSWKCTL: WKEN0 Position        */
#define CLK_PCSWKCTL_WKEN0_Msk           (0x1ul << CLK_PCSWKCTL_WKEN0_Pos)                 /*!< CLK_T::PCSWKCTL: WKEN0 Mask            */

#define CLK_PCSWKCTL_PRWKEN0_Pos         (1)                                               /*!< CLK_T::PCSWKCTL: PRWKEN0 Position      */
#define CLK_PCSWKCTL_PRWKEN0_Msk         (0x1ul << CLK_PCSWKCTL_PRWKEN0_Pos)               /*!< CLK_T::PCSWKCTL: PRWKEN0 Mask          */

#define CLK_PCSWKCTL_PFWKEN0_Pos         (2)                                               /*!< CLK_T::PCSWKCTL: PFWKEN0 Position      */
#define CLK_PCSWKCTL_PFWKEN0_Msk         (0x1ul << CLK_PCSWKCTL_PFWKEN0_Pos)               /*!< CLK_T::PCSWKCTL: PFWKEN0 Mask          */

#define CLK_PCSWKCTL_WKPSEL0_Pos         (4)                                               /*!< CLK_T::PCSWKCTL: WKPSEL0 Position      */
#define CLK_PCSWKCTL_WKPSEL0_Msk         (0xful << CLK_PCSWKCTL_WKPSEL0_Pos)               /*!< CLK_T::PCSWKCTL: WKPSEL0 Mask          */

#define CLK_PCSWKCTL_DBEN0_Pos           (8)                                               /*!< CLK_T::PCSWKCTL: DBEN0 Position        */
#define CLK_PCSWKCTL_DBEN0_Msk           (0x1ul << CLK_PCSWKCTL_DBEN0_Pos)                 /*!< CLK_T::PCSWKCTL: DBEN0 Mask            */

#define CLK_PCSWKCTL_WKEN1_Pos           (16)                                              /*!< CLK_T::PCSWKCTL: WKEN1 Position        */
#define CLK_PCSWKCTL_WKEN1_Msk           (0x1ul << CLK_PCSWKCTL_WKEN1_Pos)                 /*!< CLK_T::PCSWKCTL: WKEN1 Mask            */

#define CLK_PCSWKCTL_PRWKEN1_Pos         (17)                                              /*!< CLK_T::PCSWKCTL: PRWKEN1 Position      */
#define CLK_PCSWKCTL_PRWKEN1_Msk         (0x1ul << CLK_PCSWKCTL_PRWKEN1_Pos)               /*!< CLK_T::PCSWKCTL: PRWKEN1 Mask          */

#define CLK_PCSWKCTL_PFWKEN1_Pos         (18)                                              /*!< CLK_T::PCSWKCTL: PFWKEN1 Position      */
#define CLK_PCSWKCTL_PFWKEN1_Msk         (0x1ul << CLK_PCSWKCTL_PFWKEN1_Pos)               /*!< CLK_T::PCSWKCTL: PFWKEN1 Mask          */

#define CLK_PCSWKCTL_WKPSEL1_Pos         (20)                                              /*!< CLK_T::PCSWKCTL: WKPSEL1 Position      */
#define CLK_PCSWKCTL_WKPSEL1_Msk         (0xful << CLK_PCSWKCTL_WKPSEL1_Pos)               /*!< CLK_T::PCSWKCTL: WKPSEL1 Mask          */

#define CLK_PCSWKCTL_DBEN1_Pos           (24)                                              /*!< CLK_T::PCSWKCTL: DBEN1 Position        */
#define CLK_PCSWKCTL_DBEN1_Msk           (0x1ul << CLK_PCSWKCTL_DBEN1_Pos)                 /*!< CLK_T::PCSWKCTL: DBEN1 Mask            */

#define CLK_PDSWKCTL_WKEN0_Pos           (0)                                               /*!< CLK_T::PDSWKCTL: WKEN0 Position        */
#define CLK_PDSWKCTL_WKEN0_Msk           (0x1ul << CLK_PDSWKCTL_WKEN0_Pos)                 /*!< CLK_T::PDSWKCTL: WKEN0 Mask            */

#define CLK_PDSWKCTL_PRWKEN0_Pos         (1)                                               /*!< CLK_T::PDSWKCTL: PRWKEN0 Position      */
#define CLK_PDSWKCTL_PRWKEN0_Msk         (0x1ul << CLK_PDSWKCTL_PRWKEN0_Pos)               /*!< CLK_T::PDSWKCTL: PRWKEN0 Mask          */

#define CLK_PDSWKCTL_PFWKEN0_Pos         (2)                                               /*!< CLK_T::PDSWKCTL: PFWKEN0 Position      */
#define CLK_PDSWKCTL_PFWKEN0_Msk         (0x1ul << CLK_PDSWKCTL_PFWKEN0_Pos)               /*!< CLK_T::PDSWKCTL: PFWKEN0 Mask          */

#define CLK_PDSWKCTL_WKPSEL0_Pos         (4)                                               /*!< CLK_T::PDSWKCTL: WKPSEL0 Position      */
#define CLK_PDSWKCTL_WKPSEL0_Msk         (0xful << CLK_PDSWKCTL_WKPSEL0_Pos)               /*!< CLK_T::PDSWKCTL: WKPSEL0 Mask          */

#define CLK_PDSWKCTL_DBEN0_Pos           (8)                                               /*!< CLK_T::PDSWKCTL: DBEN0 Position        */
#define CLK_PDSWKCTL_DBEN0_Msk           (0x1ul << CLK_PDSWKCTL_DBEN0_Pos)                 /*!< CLK_T::PDSWKCTL: DBEN0 Mask            */

#define CLK_PDSWKCTL_WKEN1_Pos           (16)                                              /*!< CLK_T::PDSWKCTL: WKEN1 Position        */
#define CLK_PDSWKCTL_WKEN1_Msk           (0x1ul << CLK_PDSWKCTL_WKEN1_Pos)                 /*!< CLK_T::PDSWKCTL: WKEN1 Mask            */

#define CLK_PDSWKCTL_PRWKEN1_Pos         (17)                                              /*!< CLK_T::PDSWKCTL: PRWKEN1 Position      */
#define CLK_PDSWKCTL_PRWKEN1_Msk         (0x1ul << CLK_PDSWKCTL_PRWKEN1_Pos)               /*!< CLK_T::PDSWKCTL: PRWKEN1 Mask          */

#define CLK_PDSWKCTL_PFWKEN1_Pos         (18)                                              /*!< CLK_T::PDSWKCTL: PFWKEN1 Position      */
#define CLK_PDSWKCTL_PFWKEN1_Msk         (0x1ul << CLK_PDSWKCTL_PFWKEN1_Pos)               /*!< CLK_T::PDSWKCTL: PFWKEN1 Mask          */

#define CLK_PDSWKCTL_WKPSEL1_Pos         (20)                                              /*!< CLK_T::PDSWKCTL: WKPSEL1 Position      */
#define CLK_PDSWKCTL_WKPSEL1_Msk         (0xful << CLK_PDSWKCTL_WKPSEL1_Pos)               /*!< CLK_T::PDSWKCTL: WKPSEL1 Mask          */

#define CLK_PDSWKCTL_DBEN1_Pos           (24)                                              /*!< CLK_T::PDSWKCTL: DBEN1 Position        */
#define CLK_PDSWKCTL_DBEN1_Msk           (0x1ul << CLK_PDSWKCTL_DBEN1_Pos)                 /*!< CLK_T::PDSWKCTL: DBEN1 Mask            */
