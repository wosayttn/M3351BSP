...
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_EDGE_ALIGNED                         (PWM_DOWN_COUNTER)      /*!< PWM working in edge aligned type(down count) */
#define PWM_CENTER_ALIGNED                       (PWM_UP_DOWN_COUNTER)      /*!< PWM working in center aligned type */
...
#define PWM_TRIGGER_ADC_EVEN_CMP_UP_COUNT_POINT             PWM_TRIGGER_ADC_EVEN_COMPARE_UP_COUNT_POINT
#define PWM_TRIGGER_ADC_EVEN_CMP_DOWN_COUNT_POINT           PWM_TRIGGER_ADC_EVEN_COMPARE_DOWN_COUNT_POINT
#define PWM_TRIGGER_ADC_ODD_CMP_UP_COUNT_POINT              PWM_TRIGGER_ADC_ODD_COMPARE_UP_COUNT_POINT
#define PWM_TRIGGER_ADC_ODD_CMP_DOWN_COUNT_POINT            PWM_TRIGGER_ADC_ODD_COMPARE_DOWN_COUNT_POINT

#define PWM_TRIGGER_DAC_ZERO                            (0x1U)           /*!< PWM trigger DAC while counter down count to 0  \hideinitializer */
#define PWM_TRIGGER_DAC_PERIOD                          (0x100U)         /*!< PWM trigger DAC while counter matches (PERIOD + 1) \hideinitializer */
#define PWM_TRIGGER_DAC_COMPARE_UP                      (0x10000U)       /*!< PWM trigger DAC while counter up count to CMPDAT \hideinitializer */
#define PWM_TRIGGER_DAC_COMPARE_DOWN                    (0x1000000U)     /*!< PWM trigger DAC while counter down count to CMPDAT \hideinitializer */
...
#define PWM_FB_EDGE_ADC0RM                       (PWM_BRKCTL0_1_EADC0EBEN_Msk)     /*!< ADC0 Result Monitor (ADCRM) as edge-detect fault brake source */
#define PWM_FB_EDGE_ADC1RM                       (PWM_BRKCTL_EADC1EBEN_Msk)     /*!< ADC1 Result Monitor (ADCRM) as edge-detect fault brake source */
...
#define PWM_FB_EDGE_SYS_RAM                      (PWM_BRKCTL0_1_SYSEBEN_Msk | PWM_FAILBRK_RAMBRKEN_Msk)    /*!< System fail condition: SRAM ECC Error detection as edge-detect fault brake source */
...
#define PWM_FB_EDGE_SYS_FLASH                    (PWM_BRKCTL0_1_SYSEBEN_Msk | PWM_FAILBRK_FLASHBRKEN_Msk)    /*!< System fail condition: FLASH ECC Error detection as edge-detect fault brake source */
#define PWM_FB_EDGE_SYS_NSRAM                    (PWM_BRKCTL0_1_SYSEBEN_Msk | PWM_FAILBRK_NSRAMBRKEN_Msk)    /*!< System fail condition: SRAM non security ECC Error detection as edge-detect fault brake source */
#define PWM_FB_EDGE_SYS_NSFLASH                  (PWM_BRKCTL0_1_SYSEBEN_Msk | PWM_FAILBRK_NSFLASHBRKEN_Msk)    /*!< System fail condition: FLASH non security ECC Error detection as edge-detect fault brake source */
...
#define PWM_FB_LEVEL_ADC0RM                      (PWM_BRKCTL0_1_EADC0LBEN_Msk)     /*!< ADC0 Result Monitor (ADCRM) as level-detect fault brake source */
#define PWM_FB_LEVEL_ADC1RM                      (PWM_BRKCTL_EADC1LBEN_Msk)     /*!< ADC1 Result Monitor (ADCRM) as level-detect fault brake source */
...
#define PWM_FB_LEVEL_SYS_RAM                     (PWM_BRKCTL0_1_SYSLBEN_Msk | PWM_FAILBRK_RAMBRKEN_Msk)    /*!< System fail condition: SRAM ECC Error detection as level-detect fault brake source */
...
#define PWM_FB_LEVEL_SYS_FLASH                   (PWM_BRKCTL0_1_SYSLBEN_Msk | PWM_FAILBRK_FLASHBRKEN_Msk)    /*!< System fail condition: FLASH ECC Error detection as level-detect fault brake source */
#define PWM_FB_LEVEL_SYS_NSRAM                   (PWM_BRKCTL0_1_SYSLBEN_Msk | PWM_FAILBRK_NSRAMBRKEN_Msk)    /*!< System fail condition: SRAM non security ECC Error detection as level-detect fault brake source */
#define PWM_FB_LEVEL_SYS_NSFLASH                 (PWM_BRKCTL0_1_SYSLBEN_Msk | PWM_FAILBRK_NSFLASHBRKEN_Msk)    /*!< System fail condition: FLASH non security ECC Error detection as level-detect fault brake source */
...
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_IFA_ZERO_POINT                  (0UL)         /*!< PWM counter equal to zero  \hideinitializer */
#define PWM_IFA_PERIOD_POINT                (1UL)         /*!< PWM counter equal to period \hideinitializer */
#define PWM_IFA_COMPARE_UP_COUNT_POINT      (2UL)         /*!< PWM counter up count to comparator value \hideinitializer */
#define PWM_IFA_COMPARE_DOWN_COUNT_POINT    (3UL)         /*!< PWM counter down count to comparator value \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_EXT_TGR_PIN_INT0                (0U)         /*!< PWM external event trigger source form INT0 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT1                (1U)         /*!< PWM external event trigger source form INT1 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT2                (2U)         /*!< PWM external event trigger source form INT2 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT3                (3U)         /*!< PWM external event trigger source form INT3 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT4                (4U)         /*!< PWM external event trigger source form INT4 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT5                (5U)         /*!< PWM external event trigger source form INT5 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT6                (6U)         /*!< PWM external event trigger source form INT6 pin \hideinitializer */
#define PWM_EXT_TGR_PIN_INT7                (7U)         /*!< PWM external event trigger source form INT7 pin \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  External Event Trigger Counter Action Constant Definitions                                             */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_EXT_TGR_COUNTER_RESET              (0U)      /*!< PWM external event trigger counter reset \hideinitializer */
#define PWM_EXT_TGR_COUNTER_START              (1U)      /*!< PWM external event trigger counter start \hideinitializer */
#define PWM_EXT_TGR_COUNTER_RESET_AND_START    (2U)      /*!< PWM external event trigger counter reset and start \hideinitializer */
