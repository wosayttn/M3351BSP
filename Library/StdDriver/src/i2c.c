...
{
    uint32_t u32AddrRegValue = ((uint32_t)(u16SlaveAddr & 0x3ffUL) << 1UL) | u8GCMode;
...
{
    uint32_t u32AddrMskRegValue = (uint32_t)(u16SlaveAddrMask & 0x3ffUL) << 1UL;
