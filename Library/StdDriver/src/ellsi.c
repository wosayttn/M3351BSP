                ...
                uint32_t u32IDOS)
{
    ...
    /* ELLSI_Open not Enable ELLSI Tx */
}

/**
  * @brief  This function makes the ELLSI module ready by applying its configuration.
  * @param[in]  ellsi The pointer of the specified ELLSI module.
  * @param[in]  sELLSIConfig Specify the ELLSI information for Setting. It includes:
  *             u32ELLSIMode Decides the transfer mode. (ELLSI_MODE_SW, ELLSI_MODE_PDMA)
  *             u32OutputFormat Decides the output format of ELLSI transaction. (ELLSI_FORMAT_RGB, ELLSI_FORMAT_GRB)
  *             u32BusClock The expected frequency of ELLSI bus clock in Hz.
  *             u32TransferTimeNsec The expected period of ELLSI data transfer time in nano second.
  *             u32T0HTimeNsec The expected period of ELLSI T0H data time in nano second.
  *             u32T1HTimeNsec The expected period of ELLSI T1H data time in nano second.
  *             u32ResetTimeNsec The expected period of ELLSI reset command time in nano second.
...
void ELLSI_OpenbyConfig(ELLSI_T *ellsi, S_ELLSI_CONFIG_T *sELLSIConfig)
{
    ELLSI_Open(ellsi, sELLSIConfig->u32ELLSIMode, sELLSIConfig->u32OutputFormat, sELLSIConfig->sTimeInfo.u32BusClock,
               ...
               sELLSIConfig->u32PCNT, sELLSIConfig->u32IDOS);
}
