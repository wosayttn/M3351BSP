...
/**
  ...
  *                         - \ref TIMER_INTERCAPSEL_ACMP0
  *                         - \ref TIMER_INTERCAPSEL_ACMP1
  *                         - \ref TIMER_INTERCAPSEL_HXT
  *                         - \ref TIMER_INTERCAPSEL_LXT
  *                         - \ref TIMER_INTERCAPSEL_HIRC
  *                         - \ref TIMER_INTERCAPSEL_LIRC
  * @return     None
...
/**
  * @brief      Enable Timer Event Counter Function
  * @param[in]  timer       The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
...
/**
  * @brief      Disable Timer Event Counter Function
  * @param[in]  timer   The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
  * @return     None
...
/**
  ...
  * @param[in] u32DropCount This parameter has no effect in M3351 series BSP
  * @param[in] u32Timeout This parameter has no effect in M3351 series BSP
...
/**
  ...
  * @param[in] timer The base address of Timer module
  * @param[in] u32Mask The mask of modules (PWM/BPWM, EADC, DAC and PDMA) trigger by timer. Is the combination of
